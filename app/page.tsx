...
const C = {
  kk: {
    ...
    pricing: {
      ...
      subtitle: 'Дара — той үшін төлем, Той — айлық жазылым.',
      popular: 'Танымал',
      plans: [
        ...
        { name: 'Дара', price: '6 990 ₸', sub: 'той үшін', cta: 'Той құру →', highlight: true, features: ['1 той', '300 қонаққа дейін', 'Барлық үлгілер', 'Фото және музыка', 'Қонақтарды отырғызу', 'Қонақтарға еске салу'] },
        { name: 'Той', price: '9 990 ₸', sub: 'айына', cta: 'Той құру →', highlight: false, features: ['Айына 5 тойға дейін', '1 000 қонаққа дейін', 'Барлық үлгілер', 'Басым қолдау', 'Toyla логосыз', 'Барлық мүмкіндіктер'] },
      ],
    },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Қанша тұрады?', a: 'Тегін бастауға болады. Дара — той үшін 6 990 ₸, Той — айына 9 990 ₸.' },
      ],
    },
  ...
  ru: {
    ...
    pricing: {
      ...
      subtitle: 'Дара — оплата за той, Той — месячная подписка.',
      popular: 'Популярный',
      plans: [
        ...
        { name: 'Дара', price: '6 990 ₸', sub: 'за той', cta: 'Создать той →', highlight: true, features: ['1 той', 'до 300 гостей', 'Все шаблоны', 'Фото и музыка', 'Рассадка гостей', 'Напоминания гостям'] },
        { name: 'Той', price: '9 990 ₸', sub: 'в месяц', cta: 'Создать той →', highlight: false, features: ['До 5 тоев в месяц', 'до 1 000 гостей', 'Все шаблоны', 'Приоритетная поддержка', 'Без логотипа Toyla', 'Все возможности'] },
      ],
    },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Сколько стоит?', a: 'Можно начать бесплатно. Дара — 6 990 ₸ за той, Той — 9 990 ₸ в месяц.' },
      ],
    },
